...
- LLM self-evaluation Arm B, PGX31-PGX33 only with source-support labels withheld: after removing sentinel cues, GPT-5.6-terra matched PGX32 and PGX33 but attributed PGX31 to claim strength, while Grok-4.5 matched PGX31 and PGX32 but attributed PGX33 to claim strength.
