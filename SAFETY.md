...
The implemented monitor checks whether alert text should be allowed, narrowed, abstained, or denied as a matter of claim permission. Clinician or pharmacist authority remains outside the model.
